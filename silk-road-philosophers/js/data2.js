    ...
    nodes: [
      {
        ...
        choices: [
          { label: "Strong — a rope of many strands beats a bar of one metal.", insight: 3,
            reply: "So it has proven. No single faith among us could have done this: the Greeks kept the books, the Syriac church kept the reading of them, Islam built the house and paid the gold, and the Sabians kept the stars. Cut any strand and the rope drops the load. Toleration is not a courtesy here. It is the engineering. And the rope reaches farther than you would credit: fur-traders from the frozen rivers of the far north sell in our markets — enormous, cheerful, alarming men who pay in OUR minted silver and sing verses about a one-eyed god. Find their skald by the river gate; his people's saying opens him: FAME NEVER DIES." },
      ...
      },
      {
        ...
        choices: [
          { label: "The Stoic's amor fati, the Daoist's wu wei, the Buddhist's release — you've rebuilt the summit from your own side.", insight: 3,
            reply: "From my own side — yes, that is the phrase. Every tradition you name climbed by its own face of the mountain: the Stoic through duty, the Buddhist through the extinguishing of craving, the hermit through water's patience, I through Euclid, of all ladders. And the summit reports agree: freedom is not the world obeying you; it is understanding the world until obedience becomes a meaningless word. Perhaps the mountain has only one top. That would explain a great deal about the road you walked. ...And one climber more, since you collect summit reports: our East India ships keep one tiny window into sealed Japan, and a captain once told me of a sword-saint there who won sixty duels, then retired to a cave to write of ground, water, fire, wind — and void. The Japanese quarter by the docks keeps his book. Whisper FIVE RINGS to the doorkeeper." },
